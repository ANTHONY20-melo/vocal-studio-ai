      ...
      <div className="mt-4 space-y-4">
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            >
              <option value="femalePop">{t.voiceStyles?.femalePop || 'Female Pop'}</option>
              <option value="femaleHigh">{t.voiceStyles?.femaleHigh || 'Female High'}</option>
              <option value="gospelFemale">{t.voiceStyles?.gospelFemale || 'Gospel Female'}</option>
              <option value="maleDeep">{t.voiceStyles?.maleDeep || 'Male Deep'}</option>
              <option value="maleHigh">{t.voiceStyles?.maleHigh || 'Male High'}</option>
              <option value="maleRock">{t.voiceStyles?.maleRock || 'Male Rock'}</option>
              <option value="gospelMale">{t.voiceStyles?.gospelMale || 'Gospel Male'}</option>
              <option value="falsetto">{t.voiceStyles?.falsetto || 'Falsetto'}</option>
              <option value="melismatic">{t.voiceStyles?.melismatic || 'Melismatic'}</option>
              <option value="soulful">{t.voiceStyles?.soulful || 'Soulful'}</option>
            </select>
            <button 
